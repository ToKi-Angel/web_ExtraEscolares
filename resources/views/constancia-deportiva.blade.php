...
<body>
    <table>
        <tbody>
            <tr>
                <td rowspan="3"
                    style="text-align: center; vertical-align: middle; font-weight: bold; font-size: 12px; width: 120px; height:70px;"><img src="https://www.tecnm.mx/images/dir_calidad/re/logo_calidad.jpg" alt="logo" class="logoVerde ml-5"></td>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p style="text-align: justify; font-size: 12px;">El que suscribe <b><u>AQUINO SEGURA ROLDAN</u></b>,
                        ...
                        de la carrera <b class="m"><u>{{ $alumno->tipo }}</u></b>, ha cumplido su actividad
