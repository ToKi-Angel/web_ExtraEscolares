                        ...
                        <div class="card shadow-2-strong">
                            <div class="card-body p-5 text-center">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="text" class="form-control transparent-input form-control-lg"
                                        name="name" required placeholder="Tu usuario"/>

                                </div>
                                <div class="form-outline mb-4">
                                    <label class="form-label">Password</label>
                                    <input type="password" name="password"
                                        class="form-control transparent-input form-control-lg" required placeholder="Tu contraseña"/>
